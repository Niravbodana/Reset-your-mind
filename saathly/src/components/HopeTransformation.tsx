...
export function HopeTransformation() {
  ...
  return (
    <section id="transform" className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 relative">
        ...
        <ScrollReveal delay={0.08}>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3 md:gap-4 rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50">
                <div className="relative aspect-[16/10] md:aspect-[16/11] md:min-h-[340px] lg:min-h-[420px] overflow-hidden group">
                  ...
                  <div className="absolute top-5 left-5 md:top-6 md:left-6">
                    <span className="text-xs font-bold uppercase tracking-[0.2em] px-4 py-2 rounded-full bg-black/50 text-red-200 border border-red-400/40 backdrop-blur-md">
                      Pehle
                    </span>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                    <p className="text-lg md:text-xl text-white/95 font-medium leading-snug max-w-md">
                      {story.before}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative aspect-[16/10] md:aspect-[16/11] md:min-h-[340px] lg:min-h-[420px] overflow-hidden group">
                  ...
                  <div className="absolute top-5 left-5 md:top-6 md:left-6">
                    <span className="text-xs font-bold uppercase tracking-[0.2em] px-4 py-2 rounded-full bg-gold/20 text-gold-light border border-gold/50 backdrop-blur-md flex items-center gap-2">
                      <Sparkles size={14} />
                      Ab RIZN ke saath
                    </span>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                    <p className="text-lg md:text-xl text-white font-semibold leading-snug max-w-md">
                      {story.after}
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-6 md:mt-0 md:absolute md:-bottom-8 md:left-1/2 md:-translate-x-1/2 md:w-[min(520px,90%)] z-20">
                <div className="premium-card shimmer-border rounded-2xl p-5 md:p-6 shadow-2xl shadow-gold/10 backdrop-blur-xl bg-black/60">
                  <p className="text-[10px] font-semibold uppercase tracking-wider text-gold-light mb-3 text-center">
                    {story.name} ko aisa message aata hai
                  </p>
                  <p className="text-[15px] md:text-base leading-relaxed text-white text-center">
                    {story.message}
                  </p>
        ...
        <ScrollReveal delay={0.2} className="text-center mt-14 md:mt-16">
          <Link
            href="/signup"
