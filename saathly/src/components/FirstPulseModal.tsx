  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="soft-card rounded-2xl max-w-md w-full p-8 relative border border-gold/30">
        ...
        <h2 className="font-display text-2xl font-bold text-white mb-4">Welcome, {name}</h2>
        ...
        <Link href="/#app" className="block text-center text-xs text-muted mt-3 hover:text-gold-light">
          App kab aayegi?
        </Link>
      </div>
    </div>
