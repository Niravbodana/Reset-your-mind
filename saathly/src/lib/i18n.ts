...
const en: Dict = {
  ...
  "signup.subtitle": "Continue with Google — no phone OTP needed.",
  ...
  "signup.googleHint": "One tap — Gmail verified. No mobile OTP.",
  ...
  "login.subtitle": "Sign in with Google or the email on this device.",
...
const hi: Dict = {
  ...
  "signup.subtitle": "Google से जारी रखें — मोबाइल OTP की ज़रूरत नहीं।",
  ...
  "signup.googleHint": "एक टैप — Gmail वेरिफाइड। मोबाइल OTP नहीं।",
